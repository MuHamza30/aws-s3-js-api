...
import com.amazonaws.s3.testing.HttpCallbackCatcher;
...
public class BaseControllerTest {
     ...
     */
    protected static AWSS3Client createConfigurationFromEnvironment() {
        AWSS3Client.Builder builder = new AWSS3Client.Builder();

        final String environment = System.getenv("AWSS_3_LIB_ENVIRONMENT");
        final String timeout = System.getenv("AWSS_3_LIB_TIMEOUT");
     ...
     */
    protected static AWSS3Client createConfiguration() {
        // Set Configuration parameters for test execution
        AWSS3Client config = createConfigurationFromEnvironment();
